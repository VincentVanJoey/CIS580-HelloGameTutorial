...
namespace HelloGame
{
    public class Game1 : Game
    {
        ...
        protected override void Initialize()
        {
            ...
            // Pulled these out to read cleaner
            int ViewportWidth = (_graphics.GraphicsDevice.Viewport.Width - 64) / 2;
            int ViewportHeight = (_graphics.GraphicsDevice.Viewport.Height - 64) / 2;
            _ballPosition = new Vector2(ViewportWidth, ViewportHeight);
